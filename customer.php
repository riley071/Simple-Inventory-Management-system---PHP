			...
			<form action="" id="manage-customer">
				<div class="card">
					...
					<div class="card-body">
							...
							<div class="form-group">
								<label class="control-label">Address & Contact</label>
							...
							<tbody>
								...
								<tr>
									...
									<td class="">
										...
										<p><small>Email : <b><?php echo $row['contact'] ?></b></small></p>
...
<script>
	// AJAX request to save or update customer data
	$('#manage-customer').submit(function(e){
		...
		$.ajax({
		    ...
		    method: 'POST',
		    type: 'POST',
			// Success message for updating customer
	...
	// Filling form fields with customer data for editing
	...
	$('.delete_customer').click(function(){
	 ...
	 // AJAX request to delete customer data
