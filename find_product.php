...
<script>
	// When the user types in the search input field with ID 'search'
	$('#search').keyup(function(){
		var txt = $(this).val(); // Get the value of the input field
		// Iterate through each row in the table body with ID 'plist'
		$('#plist tbody tr').each(function(){
			// If the text of the row contains the typed text (case-insensitive)
	...
	// When a row in the table body with ID 'plist' is clicked
	$('#plist tbody tr').click(function(){
		select_prod($(this).attr('data-id')); // Call the function 'select_prod' with the data-id attribute of the clicked row
	})
	
	// When the document is ready
	$(document).ready(function(){
		$('#search').trigger('click'); // Trigger a click event on the search input field
	})
</script>
